...
CREATE TABLE IF NOT EXISTS `products` (
  ...
  `product_dealer` varchar(150) NOT NULL,
  `dealer_mobile` varchar(11) NOT NULL,
  `dealer_address` varchar(350) NOT NULL,
...
INSERT INTO `products` (`product_id`, `product_cat`, `product_brand`, `product_dealer`, `dealer_mobile`, `dealer_address`, `product_title`, `product_price`, `product_desc`, `product_image`, `product_keywords`) VALUES
(1, 1, '2', 'SS Traders', '9856345896', '9,Ganesh chok,tower road, Ahemdabad.', 'Samsung galaxy s7 edge', '5000', 'Samsung galaxy s7 edge', 'product07.png', 'samsung mobile electronics'),
...
(82, 2, '2', '', '', '', 'Suhrad', '100', 'dfgkjdflgmdfgkdflmgdfl', '1619617465_20190329_100549.jpg', 'dsfds'),
(83, 1, '2', '', '', '', 'bjvkt', '150', 'borg', '1619701524_1619700793_dress_shirt_PNG.png', 'fu'),
(84, 3, 'tirth', 'onlie traders', '9635645893', 'Anand', 'tirth', '1564', 'othnoh', '1619711589_1619700793_dress_shirt_PNG.png', 'super');
...
(1, 'Suhrad Makwana', 'suhrad@gmail.com', '123456789');
